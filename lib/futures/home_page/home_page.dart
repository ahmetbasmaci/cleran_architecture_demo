...
import 'package:cleran_architecture_demo/futures/localization/presentation/pages/localization_page.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.translate), label: "Localization"),
        ],
